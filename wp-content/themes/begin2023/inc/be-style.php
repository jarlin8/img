...
function be_styles(){
	...
	if (zm_get_option("all_color")) {
		...
		$styles .= ".top-menu a:hover,#user-profile a:hover,.nav-search:hover,.nav-search:hover:after,#navigation-toggle:hover,.nav-mobile:hover,.nav-mobile a:hover,.single-meta a:hover,.ajax-pagination a:hover,.comment-tool a:hover,.ias-next .be,.slider-home .owl-nav,.slider-group .owl-nav,.slider-single .owl-nav,.tabs-more a:hover,.single-content p a,.single-content table a,.single-content p a:visited,a:hover,.new-icon .be, #site-nav .down-menu > .current-menu-item > a, #site-nav .down-menu > .current-post-ancestor > a, #site-nav .down-menu > li > a:hover, #site-nav .down-menu > li.sfHover > a, .sf-arrows > li > .sf-with-ul:focus:after,.sf-arrows > li:hover > .sf-with-ul:after,.sf-arrows > .sfHover > .sf-with-ul:after, #site-nav .down-menu > .current-post-ancestor > .sf-with-ul:after, #site-nav .down-menu > .current-menu-item > .sf-with-ul:after, .toc-ul-box .sup a:hover, .toc-ul-box a.active, #all-series h4, .serial-number:before, #site-nav .down-menu > li > a:hover, #site-nav .down-menu > li.behover > a {color:#" . $all_color . ";}.menu_c #site-nav .down-menu > li > a:hover,.menu_c #site-nav .down-menu > li.sfHover > a,.menu_c #site-nav .down-menu > .current-menu-item > a,.menu_c #site-nav .down-menu > .current-post-ancestor > a,.sign input[type='submit'],.entry-more a,#wp-calendar a,.page-button:hover,.new-more a:hover,.new-more-img a:hover,.owl-dots .owl-dot.active span, .owl-dots .owl-dot:hover span,.owl-carousel .owl-nav button.owl-next,.owl-carousel .owl-nav button.owl-prev,.down-doc a,.down-button a,.begin-tabs-content .tab_title.selected a:after,.group-phone a,#series-letter li,.fancybox-navigation .fancybox-button div:hover,.night .begin-tabs-content .tab_title.selected a::after,.thumbnail .cat a,.title-l,.cms-news-grid-container .marked-ico,.gw-ico i,.t-mark#site-nav .down-menu > .current-menu-item > a:hover:before, .main-nav .down-menu a:hover:before, .slide-progress, .btn-login:hover, .cms-picture-cat-title, .menu_c #site-nav .down-menu > li > a:hover, .menu_c #site-nav .down-menu > li.behover > a, .contact-form button, .slide-mail-box.active .slide-mail-btu, .menu-container-o, .apc-title-date-box, .apc-title-meta, .bea-texonomy.active {background:#" . $all_color . ";}.pretty.success input:checked + label i:before {background:#" . $all_color . " !important;}.pretty.success input:checked + label i:after, .deanmove:hover .de-button a, #apc-navigation .page-numbers.current {border:#" . $all_color . ";background:#" . $all_color . " !important;}#respond input[type='text']:focus,#respond textarea:focus,.pagination a,.pagination a:visited,.page-button,.ball-pulse > div,.new-more a,.new-more-img a,.grid-cat-title:hover .title-i span,.cat-title:hover .title-i span,.cat-square-title:hover .title-i span,.widget-title:hover .title-i span,.cat-grid-title:hover .title-i span,.child-title:hover .title-i span,.add-link input:focus,.add-link textarea:focus,.max-num,.add-link input:focus,.add-link textarea:focus, .deanmove:hover .de-button a:before, .add-img-but:hover, .owl-dots .owl-dot:hover span:before, .owl-dots .owl-dot.active span:before, .my-gravatar-apply a, .user-profile .submit, .update-avatar {border:1px solid #" . $all_color . ";}.tab-product .tab-hd .current,.tab-area .current,.tab-title .selected{border-top:2px solid #" . $all_color . ";}.single-content h3,.single-content h4,.single-post .entry-header h1,.single-bulletin .entry-header h1,.single-video .entry-header h1,.single-tao .entry-header h1,.single-sites .entry-header h1,.single-picture .entry-header h1{border-left:5px solid #" . $all_color . ";}.all-cat a:hover, .btn-login {color:#" . $all_color . " !important;border:1px solid #" . $all_color . " !important;}.resp-vtabs .resp-tab-active:before{border-left:3px solid #" . $all_color . " !important;}.post-password-form input[type='submit']:hover,.page-links > span,.page-links a:hover span,.meta-nav:hover,#respond #submit:hover,.be_widget_cat a:hover,.widget_links a:hover,#sidebar .widget_nav_menu a:hover,#sidebar-l .widget_nav_menu a:hover,.link-all a:hover,.pagination span.current,.pagination a:hover,a.fo:hover,.tab-pagination a:hover,.widget-nav .widget_nav_menu li a:hover,.img-tab-hd .img-current,.tab-nav li a:hover,.add-link .add-link-btn:hover,#get_verify_code_btn:hover, .sidebox .userinfo a:hover, #user-profile .userinfo a:hover, .mobile-login-l a:hover, .mobile-login:hover, .mobile-login-reg a:hover,#user-profile .userinfo a.user-logout:hover {background:#" . $all_color . ";border:1px solid #" . $all_color . ";}.link-f a:hover {border:1px solid #" . $all_color . ";}.input-number {border:1px solid #" . $all_color . ";border-right: none !important;}.down a,.menu-login-btu .nav-reg a:hover, .menu-login-btu .nav-login-l a:hover, .menu-login-btu .nav-login .show-layer:hover {background:#" . $all_color . ";border: 1px solid #" . $all_color . ";}.zml-ico:hover:before,.date-new {color:#" . $all_color . ";}";
		}
	...
	if (zm_get_option("link_color")) {
		...
		$styles .= "a:hover, .single-content p a, .single-content table a, .single-content p a:visited, .top-menu a:hover, #user-profile a:hover, .comment-tool a:hover, .toc-ul-box .sup a:hover, .toc-ul-box a.active {color: #" . $link_color . ";}.grid-cat-title:hover .title-i span, .cat-title:hover .title-i span, .cat-square-title:hover .title-i span, .widget-title:hover .title-i span, .cat-grid-title:hover .title-i span, .child-title:hover .title-i span, #respond input[type='text']:focus, #respond textarea:focus, .login-tab-product input:focus, .add-link input:focus, .add-link textarea:focus{border: 1px solid #" . $link_color . "}.ball-pulse > div {border: 1px solid #" . $link_color . "}";
	}
	if (zm_get_option("menu_color")) {
		$menu_color = substr(zm_get_option("menu_color"), 1);
		$styles .= ".menu_c #site-nav .down-menu > .current-menu-item > a, .menu_c #site-nav .down-menu > .current-post-ancestor > a, .menu_c #site-nav .down-menu > li > a:hover, .menu_c #site-nav .down-menu > li.sfHover > a, #site-nav .down-menu > .current-menu-item > a:hover:before, .main-nav .down-menu a:hover:before, .menu_c #site-nav .down-menu > li > a:hover, .menu_c #site-nav .down-menu > li.behover > a, .menu-container-o {background: #" . $menu_color . "}#site-nav .down-menu > .current-menu-item > a, #site-nav .down-menu > .current-post-ancestor > a, #site-nav .down-menu > li > a:hover, #site-nav .down-menu > li.sfHover > a, .sf-arrows > li > .sf-with-ul:focus:after,.sf-arrows > li:hover > .sf-with-ul:after,.sf-arrows > .sfHover > .sf-with-ul:after, .nav-more:hover .nav-more-i, #site-nav .down-menu > .current-post-ancestor > .sf-with-ul:after, #site-nav .down-menu > .current-menu-item > .sf-with-ul:after, .nav-search:hover:after, #navigation-toggle:hover, #site-nav .down-menu > li > a:hover, #site-nav .down-menu > li.behover > a {color:#" . $menu_color . ";}.menu-login-btu .nav-reg a:hover, .menu-login-btu .nav-login-l a:hover, .menu-login-btu .nav-login .show-layer:hover{background:#" . $menu_color . ";border: 1px solid #" . $menu_color . ";}";
	}
	if (zm_get_option("button_color")) {
		$button_color = substr(zm_get_option("button_color"), 1);
		$styles .= ".pagination a,.pagination a:visited,.all-cat a:hover,.new-more a,.page-button,.max-num, .add-link input:focus, .add-link textarea:focus, .deanmove:hover .de-button a:before, .add-img-but:hover, .btn-login, .my-gravatar-apply a, .user-profile .submit, .update-avatar {border:1px solid #" . $button_color . ";}.cat-con-section{border-bottom:3px solid #" . $button_color . ";}.tab-product .tab-hd .current,.tab-area .current,.tab-title .selected{border-top:2px solid #" . $button_color . " !important;}.tabs-more a:hover,.ias-next .be,.all-cat a:hover, #all-series h4, .serial-number:before, .btn-login, .zml-ico:hover:before {color:#" . $button_color . ";}.upfile inputk, .btn-login:hover, .sign input[type='submit']{background:#" . $button_color . " !important;}.resp-vtabs .resp-tab-active:before{border-left:3px solid #" . $button_color . " !important;}.meta-nav:hover,#gallery .callbacks_here a,.orderby li a:hover,#respond #submit:hover,.login-respond,.be_widget_cat a:hover,.widget_links a:hover,#sidebar .widget_nav_menu a:hover,#sidebar-l .widget_nav_menu a:hover,#cms-widget-one .widget_nav_menu li a:hover,.tab-nav li a:hover,.pagination span.current,.pagination a:hover,.page-links > span,.page-links a:hover span,.group-tab-more a:hover,.tab-pagination a:hover,.page-button:hover, .deanmove:hover .de-button a, #get_verify_code_btn:hover, .sidebox .userinfo a:hover, #user-profile .userinfo a:hover, .mobile-login-l a:hover, .mobile-login:hover, .mobile-login-reg a:hover, #user-profile .userinfo a.user-logout:hover {background:#" . $button_color . ";border:1px solid #" . $button_color . ";}.pretty.success input:checked + label i:before, .apc-title-date-box, .apc-title-meta, .bea-texonomy.active {background:#" . $button_color . " !important;}.pretty.success input:checked + label i:after, #apc-navigation .page-numbers.current{border:#" . $button_color . ";background:#" . $button_color . " !important;}.fo:hover {background:#" . $button_color . ";border:1px solid #" . $button_color . ";}.entry-more a,.down-doc a,#series-letter li,.login-tab-product input[type='submit'],#wp-calendar a,.group-phone a,.group-more a,.new-more a:hover, .slide-progress, .contact-form button, .slide-mail-box.active .slide-mail-btu {background:#" . $button_color . ";}.link-f a:hover {border:1px solid #" . $button_color . ";}.input-number {border:1px solid #" . $button_color . ";border-right: none !important;}.down a {background:#" . $button_color . ";border: 1px solid #" . $button_color . ";}";
	}
	if (zm_get_option("cat_color")) {
		$cat_color = substr(zm_get_option("cat_color"), 1);
		$styles .= ".thumbnail .cat a, .full-cat, .format-img-cat, .title-l, .cms-news-grid .marked-ico, .cms-news-grid-container .marked-ico, .gw-ico i, .cms-picture-cat-title {background: #" . $cat_color . ";} .new-icon .be, .gw-main-b .gw-ico i,.date-new {color: #" . $cat_color . ";}";
	}
	if (zm_get_option("slider_color")) {
		$slider_color = substr(zm_get_option("slider_color"), 1);
		$styles .= ".owl-dots .owl-dot.active span, .owl-dots .owl-dot:hover span,.owl-carousel .owl-nav button.owl-next,.owl-carousel .owl-nav button.owl-prev {background: #" . $slider_color . "}.owl-dots .owl-dot:hover span:before, .owl-dots .owl-dot.active span:before{border: 1px solid #" . $slider_color . ";}";
	}
	if (zm_get_option("h_color")) {
		$h_color = substr(zm_get_option("h_color"), 1);
		$styles .= ".single-post .entry-header h1, .single-content h3, .single-content h4, .single-content h2 {border-left: 5px solid #" . $h_color . ";}";
	}

	if (zm_get_option("z_color")) {
		$z_color = substr(zm_get_option("z_color"), 1);
		$styles .= ".like-left .sharing-box .be-btn-beshare:hover, .sharing-box .be-btn-beshare:hover {background: #" . $z_color . ";border: 1px solid #" . $z_color . ";}";
	}
	...
	if ( zm_get_option( "nav_width" ) ) {
		...
		$styles .= ".nav-extend .nav-top, .nav-extend #navigation-top {width: " . $width . "px;}@media screen and (max-width: " . $width . "px) {.nav-extend .nav-top, .nav-extend #navigation-top {width: 98%;}}";
	}
