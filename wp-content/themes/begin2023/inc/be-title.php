...
<?php if ( is_tax( 'filtersa' ) || is_tax( 'filtersb' ) || is_tax( 'filtersc' ) || is_tax( 'filtersd' ) || is_tax( 'filterse' ) ) { ?><title><?php be_set_title(); ?><?php connector(); ?><?php if ( ! zm_get_option( 'blog_name' ) ) { bloginfo( 'name' );} ?></title><?php } ?>
