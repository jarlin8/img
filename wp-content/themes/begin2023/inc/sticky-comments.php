...
class BE_Sticky_Comments {
	...
	private function init() {
		...
		self::$actions = array(
			'feature'   => '<span class="dashicons dashicons-buddicons-groups"></span>',
			'unfeature' => '<span class="dashicons dashicons-buddicons-groups"></span>',
			'bury'      => '<span class="dashicons dashicons-lightbulb"></span>',
			'unbury'    => '<span class="dashicons dashicons-lightbulb"></span>'
		);
