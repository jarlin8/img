...
<div class="<?php echo implode(' ', $classes); ?>">
    ...
    <h3 class="flowhidden mb10 fontnormal position-relative <?php if (rehub_option('wishlist_disable') != '1') : ?><?php echo getHotIconclass($post->ID, true); ?><?php endif; ?>"><?php echo rh_expired_or_not($post->ID, 'span'); ?><a href="<?php echo esc_url($woolink); ?>" <?php echo '' . $wootarget; ?>>
            <?php the_title(); ?>
        </a>
    </h3>
            ...
            <?php if (rehub_option('woo_btn_disable') != '1'): ?>
                ...
                <?php elseif ($product->add_to_cart_url() != '') : ?>
                    <?php echo apply_filters(
                        'reg_grid_loop_add_to_cart_link',
                        sprintf(
