        ...
        <div class="woo_column_btn text-center">
            ...
            <?php elseif ($product->add_to_cart_url() != '') : ?>
                <?php echo apply_filters(
                    ...
                    sprintf(
                        '<a href="%s" data-product_id="%s" data-product_sku="%s" class="re_track_btn rehub-btn-font rehub-main-color rh-hovered-wrap rh-flex-center-align rh-flex-justify-center %s %s product_type_%s"%s %s>%s <span class="inlinestyle lineheight15 ml5 rh-hovered-scalebig csstranstrans">+</span></a>',
