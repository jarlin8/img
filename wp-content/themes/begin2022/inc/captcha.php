...
<?php 
	$url = get_stylesheet_directory_uri() . '/inc/captcha/';
...
<p class="label-captcha zml-ico captcha-ico">
	...
	<?php captcha_iocn(); ?>
	<input type="text" name="be_security_code" class="input captcha-input dah bk" value="" tabindex="1000" placeholder="<?php _e( '验证码', 'begin' ); ?>" onfocus="this.placeholder=''" onblur="this.placeholder='<?php _e( '验证码', 'begin' ); ?>'"><br/>
...
if (zm_get_option('login_captcha')) {
add_action('authenticate', 'login_check_code', 20, 1);
}
