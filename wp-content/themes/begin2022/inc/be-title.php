...
<?php if ( is_tax('documents') ) { ?><title><?php setTitle(); ?><?php connector(); ?><?php if (!zm_get_option('blog_name')) { bloginfo('name');} ?></title><?php } ?>
...
<meta name="description" content="<?php $sites_description = get_post_meta($post->ID, 'sites_description', true);{echo $sites_description;}?>" />
