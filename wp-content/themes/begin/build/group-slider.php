				...
				<?php if ( ! empty( $items['slider_group_img'] ) ) { ?>
					<div class="slider-group-main">
						<a href="<?php echo $items['slider_group_url']; ?>" rel="bookmark" <?php echo goal(); ?>>
							<div class="group-big-img big-back-img big-ease<?php if ( isset( $items['group_blur'] ) && $items['group_blur'] ) { ?> big-blur<?php } ?>" style="background-image: url('<?php echo $items['slider_group_img']; ?>');height:<?php echo be_build( get_the_ID(), 'big_back_img_h'); ?>px;"></div>
						</a>
