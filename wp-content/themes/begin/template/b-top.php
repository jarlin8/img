...
<div class="cms-news-grid-container b-top">
	<div class="marked-ico ms hz" <?php aos_a(); ?>><?php _e( '推荐', 'begin' ); ?></div>
	<?php query_posts( array ( 'meta_key' => 'cms_top', 'showposts' => zm_get_option('blog_top_n'), 'post__not_in' => get_option( 'sticky_posts') ) ); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
	...
	<?php endwhile; ?>
	<?php else : ?>
		<div class="be-none da bk">无推荐文章，编辑文章，勾选“首页推荐文章”</div>
	<?php endif; ?>
	<div class="clear"></div>
</div>
<?php } ?>