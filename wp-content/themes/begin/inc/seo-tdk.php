...
<?php if ( is_author() ) { ?><title><?php the_author(); ?><?php _e( '的主页', 'begin' ); ?><?php title_name(); ?></title><?php } ?>
...
<?php } ?>
<?php if ( is_year() ) { ?>
<meta name="description" content="<?php the_time('Y'); ?><?php title_name(); ?>" />
<meta name="keywords" content="<?php bloginfo( 'name' ); ?>" />
<?php } ?>
<?php if ( is_month() ) { ?>
<meta name="description" content="<?php the_time('Y'); ?>-<?php the_time('F'); ?><?php title_name(); ?>" />
<meta name="keywords" content="<?php bloginfo( 'name' ); ?>" />
<?php } ?>
<?php if ( is_day() ) { ?>
<meta name="description" content="<?php the_time('Y-n-j'); ?><?php title_name(); ?>" />
<meta name="keywords" content="<?php bloginfo( 'name' ); ?>" />
<?php } ?>
<?php if ( is_tag() ) { ?>
<meta name="description" content="<?php echo trim( strip_tags( wp_trim_words(tag_description(), 160 ) ) ); ?>" />
