...
jQuery(document).ready(function($) {
	...
	$(".csf-expand-shut").click(function() {
		if($(".csf-tab-expanded").length) {
			$('.csf-tab-item').removeClass('csf-tab-expanded');
		} else {
			$('.csf-tab-item').toggleClass('csf-tab-expanded');
		}
	});

	$(".csf-expand-all").click(function() {
		$('.be-box').toggleClass('csf-shut-all');
	});

	$(window).scroll(function(){
		if($(window).scrollTop() >= 1){
			$(".csf-header-inner").addClass('csf-header-down');
		} else{
			$(".csf-header-inner").removeClass('csf-header-down');
		}
	});
});