...
<?php $display_categories =  explode(',',zm_get_option('grid_cat_c_id') ); foreach ($display_categories as $category) { ?>
	...
	<div class="grid-cat-box">
		<div class="grid-cat-title-box">
			...
			<?php if ( zm_get_option( 'grid_cat_c_des' ) ) { ?><div class="grid-cat-des" <?php aos_a(); ?>><?php echo category_description( $category ); ?></div><?php } ?>
		</div>
		<div class="clear"></div>
		<div class="grid-cat-site grid-cat-c grid-cat-<?php echo zm_get_option('grid_cat_c_f'); ?>">
