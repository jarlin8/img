 ...
 * @LastEditors: iowen
 * @LastEditTime: 2023-03-24 23:51:57
        ...
        array(
            ...
            'fields'     => array(
                ...
                array(
                    ...
                    'default' => 'search',
                    'after'   => '【搜索框下】需选择<a href="'.io_get_admin_csf_url('搜索设置').'">“搜索布局样式”</a>选项的第2个布局',
                    'class'   => 'compact min',
                ...
                array(
                    ...
                    'default'   => array(
                        array(
                            'language' => 'zh',
                            'content'  => '<i class="iconfont icon-tishi mr-1"></i>支付后内容需审核，如内容违法<a href="'.home_url().'" target="_blank">规定</a>，将直接删除，且不退款！',
                        ),
                        array(
                            'language' => 'en',
                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            'type'    => 'submessage',
                            'style'   => 'info',
                            'content' => '<p>早期个人账号可用，但是PayPal近期调整的政策，境内用户没法对境内用户进行收款。</p>
