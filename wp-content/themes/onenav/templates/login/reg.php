 ...
 * @LastEditors: iowen
 * @LastEditTime: 2023-01-27 18:46:25
                    ...
                    <div class="col-12 col-md-6 col-lg-5 col-xl-4 bg-white rounded-xl shadow-lg">
                        <div class="form d-flex align-items-center p-4 p-md-5">
                            ...
                            <div class="content">
                                ...
                                <form name="registerform" method="post" action="<?php echo esc_url(home_url('login/?action=register')) ?>" class="form-validate" id="wp_login_form">
                                    <div class="form-group mb-0">
                                        ...
                                        <div style="color:#f1404b;height:18px"><small><?php if(!empty($user_error))  echo '<i class="iconfont icon-crying mr-2"></i>'.$user_error; ?></small></div>
                                    </div> 
                                    <?php if($is_reg){ ?>
                                    <div class="form-group mb-0">
                                        <input type="text" name="user_email" tabindex="2" id="user_email" placeholder="<?php echo get_reg_name() ?>" value="<?php if(!empty($user_email)) echo $user_email; ?>"  size="30" class="input-material"/> 
                                        <div style="color:#f1404b;height:18px"><small><?php if(!empty($email_error))  echo '<i class="iconfont icon-crying mr-2"></i>'.$email_error; ?></small></div>
                                    </div> 
                                    <div class="form-group mb-0 verification" style="display:none">
                                        ...
                                        <div style="color:#f1404b;height:18px"><small class="code-error"><?php if(!empty($code_error))  echo '<i class="iconfont icon-crying mr-2"></i>'.$code_error; ?></small></div>
                                    </div> 
                                    <?php } ?>
                                    <div class="form-group mb-0">
                                        <input type="password" name="user_pass" tabindex="4" id="user_pwd1" placeholder="<?php _e('密码','i_theme') ?>" size="30" class="input-material"/> 
                                        <div style="color:#f1404b;height:18px"><small><?php if(!empty($pass_error))  echo '<i class="iconfont icon-crying mr-2"></i>'.$pass_error; ?></small></div>
                                    </div> 
                                    <div class="form-group mb-0">
                                        <input type="password" name="user_pass2" tabindex="5" id="user_pwd2" placeholder="<?php _e('确认密码','i_theme') ?>" size="30" class="input-material"/> 
                                        <div style="color:#f1404b;height:18px"><small><?php if(!empty($pass_error2))  echo '<i class="iconfont icon-crying mr-2"></i>'.$pass_error2; ?></small></div>
                                    </div> 
