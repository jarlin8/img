...
CSF::createSection( $prefix, array(
    ...
    'fields'       => array(
        array(
            'type'    => 'submessage',
            'style'   => 'success',
            'content' => '<h4 style="font-size:18px">'.$tip_ico.'注意 & 必看</h4>
            ...
            <p><b>演示数据</b>： <a href="https://www.iotheme.cn/one-nav-yidaohangyanshishujushiyongjiaocheng.html" target="_blank">下载</a> （<b>警告</b>：安装演示数据前必须配置服务器 <b>伪静态规则</b>）</p>',
        ),
        array(
            'type'     => 'callback',
        ...
        array(
            ...
            'default' => true,
            'desc'    => $tip_ico.'请勿修改主题文件夹名称，可能会导致检查不到更新。',
        ),
        array(
            'id'      => 'update_beta',
            'type'    => 'switcher',
        ...
        array(
            'type'    => 'submessage',
            'style'   => 'success',
            'content' => $tip_ico.'<a href="https://www.iotheme.cn/update-log" target="_blank">查看更新日志</a>',
        ),
        array(
            'type'    => 'content',
            'title'   => '系统环境',
        ...
        array(
            ...
            <li><strong>操作系统</strong>：无要求，不推荐使用Windows系统</li></ul>',
        ),
    )
));
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'after'   => '可用：<code>fastly.jsdelivr.net</code> 、 <code>cdn.iowen.cn</code><br>'.$tip_ico.'留空则使用<code>cdn.jsdelivr.net</code>',
            'default' => 'fastly.jsdelivr.net',
            'class'   => 'compact',
...
CSF::createSection( $prefix, array(
    ...
    'fields'   => array(  
        ...
        array(
            ...
            'title'     => '公告页头部图片',
            'class'     => 'compact',
            'default'   => '//cdn.iowen.cn/gh/owen0o0/ioStaticResources@master/banner/banner015.jpg',
        ),
        array(
            'id'         => 'customize_card',
            'type'       => 'switcher',
...
CSF::createSection( $prefix, array(
    ...
    'fields'   => array(   
        ...
        array(
            ...
            'before'      => __('拖动排序，不需要的拖到“停用”。注：启用必须保留一个','io_setting'),
        ),
    )
));
//
...
CSF::createSection( $prefix, array(
    ...
    'fields'   => array(  
        ...
        array(
            ...
            'label'     => __('【网址块】需先开启“网址详情页”','io_setting'),
            'class'     => 'compact min',
            'dependency'  => array( 'details_page', '==', true ),
        ),
        array(
...
CSF::createSection( $prefix, array(
    ...
    'fields'      => array(
        ...
        array(
            ...
            'desc'       => '<span style="color:#000"><i class="fa fa-fw fa-info-circle fa-fw"></i> “网址”“app”“书籍”的固定链接模式<br>
...
CSF::createSection( $prefix, array(
    ...
    'fields'      => array(
        array(
            ...
            'desc'    => '<p style="color: #e31313;"><i class="fa fa-fw fa-info-circle fa-fw"></i> 启用和禁用<b>[用户中心]</b>后必须<b>重新保存固定链接</b></p>
                    <p style="color: #e31313;">'.$tip_ico.'如果关掉用户中心 <b>“用户&安全”</b> 选项卡内设置基本都无效。</p>',
            'default' => false,
        ),
        array(
...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'fields'    => array(
                array(
                    'content' => '<h4>免一切授权验证等步骤，只需要在聚合登录注册就可以使用qq、微信、微博等13种登录方式。</h4>
                    <b>接口申请：</b><a target="_blank" href="https://cl.prk123.com/">https://cl.prk123.com</a>',
                    'style' => 'info',
                    'type' => 'submessage',
                ),
                array(
    ...
    'fields'      => array(
        ...
        array(
            ...
            'options' => array(
                ...
                'qiniu'       => __('使用 七牛源 提供的加速服务','io_setting'),
            ),
        ),
        array(
            'id'      => 'remove_help_tabs',
