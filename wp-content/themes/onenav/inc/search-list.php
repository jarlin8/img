    ...
    array(
        ...
        'list'    => array(
            array(
                ...
                'id'          => 'type-br',
                'url'         => 'https://seo.5118.com/%s%',
            ),
            array(
                'name'        => __('友链检测','i_theme'),
                'placeholder' => __('请输入网址(不带https://)','i_theme'),
                'id'          => 'type-links',
                'url'         => 'https://ahrefs.5118.com/%s%',
            ),
            array(
                'name'        => __('备案查询','i_theme'),
                'placeholder' => __('请输入网址(不带https://)','i_theme'),
                'id'          => 'type-icp',
                'url'         => 'https://icp.5118.com/domain/%s%',
            ),
            array(
            ...
            array(
                ...
                'id'          => 'type-ciku',
                'url'         => 'https://www.5118.com/seo/newrelated/%s%',
            ),
            array(
                'name'        => __('素材搜索','i_theme'),
                'placeholder' => __('请输入关键词','i_theme'),
                'id'          => 'type-51key',
                'url'         => 'https://so.5118.com/all/%s%',
            ),
            array(
                'name'        => __('大数据词云','i_theme'),
                'placeholder' => __('请输入关键词','i_theme'),
                'id'          => 'type-51kt',
                'url'         => 'https://www.kt1.com/%s%',
            ),
        )
    ),
    array(
