    ...
    function form( $instance ) {
        ...
        $instance = wp_parse_args( (array) $instance, array( 
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('newWindow'); ?>"><?php _e('在新窗口打开链接','io_setting') ?></label>
            </p>
            <p>
...
class about_author extends WP_Widget {
    ...
    function form($instance) { 
        global $wpdb;
        $instance = wp_parse_args((array) $instance, array('author_back' => '//cdn.iowen.cn/gh/owen0o0/ioStaticResources@master/banner/wHoOcfQGhqvlUkd.jpg'));
