...
function io_register_sidebars(){
    $sidebars = array(
        ...
        array(
            'id'            => 'sidebar-sites-t',
            'name'          => '网站详情页顶部小工具',
            'description'   => '显示在网站详情页顶部，替换[网址详情页右边广告位]，推荐只添加一个小工具。',
        ),
        array(
            'id'            => 'sidebar-sites-r',
            'name'          => '网站详情页侧边栏',
...
function get_assets_path(){
    ...
    if(!$assets_path){
        ...
        $assets = array(
            'font-awesome'      => '//cdn.staticfile.org/font-awesome/5.15.4/css/all.min.css',
            'font-awesome4'     => '//cdn.staticfile.org/font-awesome/5.15.4/css/v4-shims.min.css',
            //移除本地fa图标
        ...
        switch(io_get_option('cdn_resources','bytecdntp')){
            ...
            case 'bytecdntp':
                ...
                $assets[ 'popper' ]         = '//cdn.staticfile.org/popper.js/1.16.0/umd/popper.min.js';
                ...
                break;
            case 'staticfile':
                $assets[ 'font-awesome' ]   = '//cdn.staticfile.org/font-awesome/5.15.4/css/all.min.css';
                $assets[ 'font-awesome4' ]  = '//cdn.staticfile.org/font-awesome/5.15.4/css/v4-shims.min.css';
                $assets[ 'bootstrap' ]      = '//cdn.staticfile.org/twitter-bootstrap/4.6.1/css/bootstrap.min.css';
                $assets[ 'swiper' ]         = '//cdn.staticfile.org/Swiper/7.4.1/swiper-bundle.min.css';
                $assets[ 'lightbox' ]       = '//cdn.staticfile.org/fancybox/3.5.7/jquery.fancybox.min.css';
            
                $assets[ 'jquery' ]         = '//cdn.staticfile.org/jquery/3.5.1/jquery.js';
                $assets[ 'clipboard-mini' ] = '//cdn.staticfile.org/clipboard.js/2.0.10/clipboard.min.js';
                $assets[ 'popper' ]         = '//cdn.staticfile.org/popper.js/1.16.0/umd/popper.min.js';
                $assets[ 'bootstrap-js' ]   = '//cdn.staticfile.org/twitter-bootstrap/4.6.1/js/bootstrap.min.js';
                $assets[ 'swiper-js' ]      = '//cdn.staticfile.org/Swiper/7.4.1/swiper-bundle.min.js';
                $assets[ 'lightbox-js' ]    = '//cdn.staticfile.org/fancybox/3.5.7/jquery.fancybox.min.js';
                $assets[ 'echarts' ]        = '//cdn.staticfile.org/echarts/5.3.0/echarts.min.js';
    
                $assets[ 'jquery-ui' ]      = '//cdn.staticfile.org/jqueryui/1.12.1/jquery-ui.min.js';
                $assets[ 'jquery-touch' ]   = '//cdn.staticfile.org/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js';
                break;
        }
        $assets_path = $assets;
    }
...
function get_assets_version($path, $v=false){
    if (preg_match('/'. str_replace('/', '\/', get_url_root(home_url())) .'/i', $path) && !strstr($path, 'cdn.iowen.cn')) {
        if($v){
            return '?ver='. VERSION;
        }
        return VERSION;
