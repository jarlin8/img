  ...
  class CSF_Setup {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        wp_enqueue_style( 'csf-fa', 'https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.min.css', array(), null, 'all' );
      } else {
        wp_enqueue_style( 'csf-fa5', 'https://cdn.staticfile.org/font-awesome/5.15.4/css/all.min.css', array(), null, 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', 'https://cdn.staticfile.org/font-awesome/5.15.4/css/v4-shims.min.css', array(), null, 'all' );
      }
