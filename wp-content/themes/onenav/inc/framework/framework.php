 ...
 * @LastEditors: iowen
 * @LastEditTime: 2023-03-23 01:40:44
...
function io_get_option($option, $default = null, $key = ''){
    ...
    $_v = io_option_to_multi_language($_v, $option, isset($options['m_language']) ? $options['m_language'] : false);
    return $_v;
}
 ...
 * @return mixed
 */
function io_option_to_multi_language($option, $key = '', $is_multi = null){
    if (empty($option)) {
        return $option;
    }
