            ...
            <div class="data_panel">
                ...
                <div clas="row">
                    ...
                    <div class="col-md-6 col-lg-6 text-right">
                        <a class='btn btn-default btn-sm' ng-click="addBlank('<?php echo esc_attr($module_id); ?>')"><i class="glyphicon glyphicon-plus"></i> <?php esc_html_e('Add offer', 'content-egg'); ?></a>
                ...
                <div class="col-md-12 added_data" ng-repeat="data in models.<?php echo esc_attr($module_id); ?>.added">
                    <div class="row" style="padding: 5px;">
                        <div class="col-md-1 text-center" ng-if="data.img">
                            <img ng-if="data.img" ng-src="{{data.img}}" class="img-responsive" style="max-height: 100px;" ng-click="buildShortcode('<?php echo esc_attr($module_id); ?>', selectedTemplate_<?php echo esc_attr($module_id); ?>, selectedGroup_<?php echo esc_attr($module_id); ?>, data.unique_id);" />
                        ...
                        <div ng-class="data.img ? 'col-md-9' : 'col-md-10'">
                            ...
                            <div class="row" style="margin:0px;">
                                <div class="col-md-6" style="padding:0px;">
                                    <input type="text" placeholder="<?php esc_html_e('Product URL', 'content-egg'); ?> (<?php esc_html_e('required', 'content-egg'); ?>)" ng-model="data.orig_url" class="form-control" style="margin-bottom: 5px;">
                                </div>
                                <div class="col-md-2" style="padding-right:0px;">
                                    <input type="text" placeholder="<?php esc_html_e('Domain', 'content-egg'); ?>" ng-model="data.domain" class="form-control" style="margin-bottom: 5px;">

                                </div>
                                <div class="col-md-4" style="padding-right:0px;">
                                    <input type="text" placeholder="<?php esc_html_e('Custom Deeplink', 'content-egg'); ?>" ng-model="data.extra.deeplink" class="form-control" style="margin-bottom: 5px;">
                                </div>
                            </div>

                            <div class="row" style="margin:0px;">
                                <div class="col-md-6" style="padding:0px;">
                                    <input type="text" placeholder="<?php esc_html_e('Product Image URL', 'content-egg'); ?>" ng-model="data.img" class="form-control" style="margin-bottom: 5px;">
                                </div>
                                <div class="col-md-6" style="padding-right:0px;">
                                    <input type="text" placeholder="<?php esc_html_e('Merchant Logo URL (optional)', 'content-egg'); ?>" ng-model="data.logo" class="form-control" style="margin-bottom: 5px;">
                                </div>
                            </div>
                            <div class="row" style="margin:0px;">
                            ...
                            <?php if ($is_woo && $module->isAffiliateParser()) : ?>
                                <label><input ng-true-value="'true'" type="checkbox" ng-model="data.woo_sync" name="woo_sync" ng-change="wooRadioChange(data.unique_id, 'woo_sync')"> <?php esc_html_e('Woo synchronization', 'content-egg'); ?>
                                </label>
                            <?php endif; ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <div>
                                ...
                                <a title="<?php esc_attr(esc_html_e('Go to', 'content-egg')); ?>" href="{{data.url}}" target="_blank">
