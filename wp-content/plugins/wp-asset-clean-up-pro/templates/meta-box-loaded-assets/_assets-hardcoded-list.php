						...
						<table class="wpacu_list_table wpacu_striped">
							...
							foreach ( $hardcodedTags[ $targetKey ] as $indexNo => $tagOutput ) {
								...
								*/
								if ($targetKey === 'link_and_style_tags') {
									...
									if ( stripos( $tagOutput, '<link ' ) === 0 ) {
										...
										// [wpacu_pro]
										$dataHH = \WpAssetCleanUp\HardcodedAssets::wpacuGenerateHardcodedAssetData( $dataRowObj, $data, 'styles' );
										// [/wpacu_pro]
								...
								*/
                                    ...
                                    // [wpacu_pro]
									$dataHH = \WpAssetCleanUp\HardcodedAssets::wpacuGenerateHardcodedAssetData( $dataRowObj, $data, 'scripts' );
                                    // [/wpacu_pro]
