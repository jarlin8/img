                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (settings.gallery === true) {
                            ...
                            if (fifuMainSliderVars.fifu_lazy)
                                pagers += '<li style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px"><a href="#"><img class="lazyload" data-src="' + thumb + '" alt="' + alt + '"/></a></li>';
                            else
                                pagers += '<li style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px"><a href="#"><img src="' + thumb + '"' + err + ' alt="' + alt + '"/></a></li>';
                        } else {
