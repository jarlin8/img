<?php
if ( !class_exists('Puc_v4p11_Fifu_Plugin_Package', false) ):

	class Puc_v4p11_Fifu_Plugin_Package extends Puc_v4p11_Fifu_InstalledPackage {
		/**
		 * @var Puc_v4p11_Fifu_Plugin_UpdateChecker
		 */
		...
		public function isMuPlugin() {
			...
			if ( $cachedResult === null ) {
				...
				if (($muPluginDir === false) || ($pluginPath === false)) {
					...
					$pluginPath  = Puc_v4p11_Fifu_Factory::normalizePath($this->pluginAbsolutePath);
				}
