...
if ( !class_exists('Puc_v4p11_Fifu_Plugin_UpdateChecker', false) ):
	 ...
	 * @access public
	 */
	class Puc_v4p11_Fifu_Plugin_UpdateChecker extends Puc_v4p11_Fifu_UpdateChecker {
		...
		/**
		 * @var Puc_v4p11_Fifu_Plugin_Package
		 */
		protected $package;
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			$this->extraUi = new Puc_v4p11_Fifu_Plugin_Ui($this);
		}
		...
		protected function createScheduler($checkPeriod) {
			$scheduler = new Puc_v4p11_Fifu_Scheduler($this, $checkPeriod, array('load-plugins.php'));
		 ...
		 * @return Puc_v4p11_Fifu_Plugin_Info
		 */
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata('Puc_v4p11_Fifu_Plugin_Info', 'request_info', $queryArgs);

			if ( $pluginInfo !== null ) {
				/** @var Puc_v4p11_Fifu_Plugin_Info $pluginInfo */
		 ...
		 *
		 * @return Puc_v4p11_Fifu_Update|null An instance of Plugin_Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			...
			$update = Puc_v4p11_Fifu_Plugin_Update::fromPluginInfo($pluginInfo);
		 ...
		 *
		 * @return Puc_v4p11_Fifu_Plugin_Update|null
		 */
		public function getUpdate() {
			$update = parent::getUpdate();
			if ( isset($update) ) {
				/** @var Puc_v4p11_Fifu_Plugin_Update $update */
		...
		protected function createDebugBarExtension() {
			return new Puc_v4p11_Fifu_DebugBar_PluginExtension($this);
		}
		...
		protected function createInstalledPackage() {
			return new Puc_v4p11_Fifu_Plugin_Package($this->pluginAbsolutePath, $this);
		}

		/**
		 * @return Puc_v4p11_Fifu_Plugin_Package
		 */
