...
if ( !class_exists('Puc_v4p11_Fifu_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class Puc_v4p11_Fifu_Plugin_Update extends Puc_v4p11_Fifu_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = Puc_v4p11_Fifu_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param Puc_v4p11_Fifu_Plugin_Info $info
		 * @return Puc_v4p11_Fifu_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|Puc_v4p11_Fifu_Plugin_Info|Puc_v4p11_Fifu_Plugin_Update $object The source object.
		 * @return Puc_v4p11_Fifu_Plugin_Update The new copy.
		 */
