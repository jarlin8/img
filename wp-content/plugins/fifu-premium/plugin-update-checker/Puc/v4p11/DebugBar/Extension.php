<?php
if ( !class_exists('Puc_v4p11_Fifu_DebugBar_Extension', false) ):

	class Puc_v4p11_Fifu_DebugBar_Extension {
		const RESPONSE_BODY_LENGTH_LIMIT = 4000;

		/** @var Puc_v4p11_Fifu_UpdateChecker */
		protected $updateChecker;
		protected $panelClass = 'Puc_v4p11_Fifu_DebugBar_Panel';
		...
		private function getLibraryUrl($filePath) {
			...
			$absolutePath = Puc_v4p11_Fifu_Factory::normalizePath($absolutePath);

			$pluginDir = Puc_v4p11_Fifu_Factory::normalizePath(WP_PLUGIN_DIR);
			$muPluginDir = Puc_v4p11_Fifu_Factory::normalizePath(WPMU_PLUGIN_DIR);
			$themeDir = Puc_v4p11_Fifu_Factory::normalizePath(get_theme_root());
