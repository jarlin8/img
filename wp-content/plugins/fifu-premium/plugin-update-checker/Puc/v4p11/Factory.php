...
if ( !class_exists('Puc_v4p11_Fifu_Factory', false) ):
	...
	class Puc_v4p11_Fifu_Factory {
		 ...
		 * @return Puc_v4p11_Fifu_Plugin_UpdateChecker|Puc_v4p11_Fifu_Theme_UpdateChecker|Puc_v4p11_Fifu_Vcs_BaseChecker
		 */
		 ...
		 *
		 * @see Puc_v4p11_Fifu_UpdateChecker::__construct
		 *
