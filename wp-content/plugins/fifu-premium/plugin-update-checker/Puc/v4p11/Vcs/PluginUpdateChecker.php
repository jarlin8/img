<?php
if ( !class_exists('Puc_v4p11_Fifu_Vcs_PluginUpdateChecker') ):

	class Puc_v4p11_Fifu_Vcs_PluginUpdateChecker extends Puc_v4p11_Fifu_Plugin_UpdateChecker implements Puc_v4p11_Fifu_Vcs_BaseChecker {
		/**
		...
		/**
		 * Puc_v4p11_Fifu_Vcs_PluginUpdateChecker constructor.
		 *
		...
		public function requestInfo($unusedParameter = null) {
			...
			$info = new Puc_v4p11_Fifu_Plugin_Info();
		 ...
		 * @param Puc_v4p11_Fifu_Plugin_Info $pluginInfo
		 */
