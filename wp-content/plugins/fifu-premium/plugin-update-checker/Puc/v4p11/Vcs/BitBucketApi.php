<?php
if ( !class_exists('Puc_v4p11_Fifu_Vcs_BitBucketApi', false) ):

	class Puc_v4p11_Fifu_Vcs_BitBucketApi extends Puc_v4p11_Fifu_Vcs_Api {
		/**
		 * @var Puc_v4p11_Fifu_OAuthSignature
		 */
		private $oauth = null;
		 ...
		 * @return null|Puc_v4p11_Fifu_Vcs_Reference
		 */
		...
		public function getBranch($branchName) {
			...
			return new Puc_v4p11_Fifu_Vcs_Reference(array(
				'name' => $ref,
		 ...
		 * @return Puc_v4p11_Fifu_Vcs_Reference|null
		 */
		...
		public function api($url, $version = '2.0') {
			$url = ltrim($url, '/');
			$isSrcResource = Puc_v4p11_Fifu_Utils::startsWith($url, 'src/');
		...
		public function setAuthentication($credentials) {
			...
			if ( !empty($credentials) && !empty($credentials['consumer_key']) ) {
				$this->oauth = new Puc_v4p11_Fifu_OAuthSignature(
