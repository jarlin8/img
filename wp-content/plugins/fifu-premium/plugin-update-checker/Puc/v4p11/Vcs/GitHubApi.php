...
if ( !class_exists('Puc_v4p11_Fifu_Vcs_GitHubApi', false) ):

	class Puc_v4p11_Fifu_Vcs_GitHubApi extends Puc_v4p11_Fifu_Vcs_Api {
		/**
		...
		public function getLatestRelease() {
			...
			$reference = new Puc_v4p11_Fifu_Vcs_Reference(array(
