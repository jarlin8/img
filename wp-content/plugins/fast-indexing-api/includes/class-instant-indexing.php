...
class RM_GIAPI {
	...
	public function register_bulk_actions( $bulk_actions ) {
		$bulk_actions['giapi_update']    = __( 'Google更新', 'fast-indexing-api' );
		$bulk_actions['giapi_getstatus'] = __( 'Google状态', 'fast-indexing-api' );
	...
	public function bing_register_bulk_actions( $bulk_actions ) {
		$bulk_actions['giapi_bing_submit'] = __( 'Bing Submit', 'fast-indexing-api' );
	...
	public function send_to_api_link( $actions, $post ) {
		...
		if ( in_array( $post->post_type, $post_types, true ) ) {
			$actions['rmgiapi_update']    = '<a href="' . admin_url( 'admin.php?page=instant-indexing&tab=console&apiaction=update&_wpnonce=' . $nonce . '&apiurl=' . rawurlencode( get_permalink( $post ) ) ) . '" class="rmgiapi-link rmgiapi_update">' . __( 'Google更新', 'fast-indexing-api' ) . '</a>';
			$actions['rmgiapi_getstatus'] = '<a href="' . admin_url( 'admin.php?page=instant-indexing&tab=console&apiaction=getstatus&_wpnonce=' . $nonce . '&apiurl=' . rawurlencode( get_permalink( $post ) ) ) . '" class="rmgiapi-link rmgiapi_update">' . __( 'Google状态', 'fast-indexing-api' ) . '</a>';
		}
		if ( in_array( $post->post_type, $bing_post_types, true ) && function_exists( 'rank_math' ) ) {
			$actions['rmgiapi_bing_submit'] = '<a href="' . admin_url( 'admin.php?page=instant-indexing&tab=console&apiaction=bing_submit&_wpnonce=' . $nonce . '&apiurl=' . rawurlencode( get_permalink( $post ) ) ) . '" class="rmgiapi-link rmgiapi_update">' . __( '提交到IndexNow', 'fast-indexing-api' ) . '</a>';
		}
