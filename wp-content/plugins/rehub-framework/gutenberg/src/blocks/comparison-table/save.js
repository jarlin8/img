...
export default function edit ( props ) {
	...
	const { bottomTitle, prosTitle, consTitle, specTitle, contentFont, responsiveView } = attributes;
	...
	return (
		<div>
			<div className={`comparison-table ${ attributes.responsiveView } ${ attributes.enableBadges ? 'has-badges' : '' }`}>
				<div className = "comparison-item comparison-header">
				...
				{ 'slide' === responsiveView && 
					<div className="comarison-controls">
						<button type="button" className="comparison-control-prev" onClick="getPrevTableItem(this)">
							<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 492 492">
						...
						<button type="button" className="comparison-control-next" onClick="getNextTableItem(this)">
							<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 492.004 492.004">
