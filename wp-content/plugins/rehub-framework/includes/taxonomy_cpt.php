                ...
                */
                public function woo_product_store_init() {
                    ...
                    register_taxonomy(
                        ...
                        array(
                            'labels' => array(
                                'name'              => esc_html__( 'Store', 'rehub-framework' ),
                                'singular_name'     => esc_html__( 'Store', 'rehub-framework' ),
                                'search_items'      => esc_html__( 'Search store', 'rehub-framework' ),
                                'all_items'         => esc_html__( 'All stores', 'rehub-framework' ),
                                'parent_item'       => esc_html__( 'Parent store', 'rehub-framework' ),
                                'parent_item_colon' => esc_html__( 'Parent store:', 'rehub-framework' ),
                                ...
                                'add_new_item'      => esc_html__( 'Add new store', 'rehub-framework' ),
                                'new_item_name'     => esc_html__( 'New store name', 'rehub-framework' ),
                                'menu_name'         => esc_html__( 'Store', 'rehub-framework' ),
                            ),      
                            'show_ui' => true,
                            'show_admin_column' => true,
                            'update_count_callback' => '_update_post_term_count',
                            'hierarchical' => true,
                            'public' => true,
                            'query_var' => empty( $permalinks['store_base'] ) ? 'brandstore' : $permalinks['store_base'],
                            'show_in_quick_edit' => true,
                            'rewrite' =>array(
                                'slug' => empty( $permalinks['store_base'] ) ? 'brandstore' : $permalinks['store_base'],
                                'with_front'   => false,
                                'hierarchical' => true,
                            ),
                            'show_in_rest' => true
