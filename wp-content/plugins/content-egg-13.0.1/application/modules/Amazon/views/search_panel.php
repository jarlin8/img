...
<input type="text" class="form-control form-control-sm" ng-model="query_params.Amazon.minimum_price" ng-init="query_params.Amazon.minimum_price = ''" placeholder="<?php esc_html_e('Min. price', 'content-egg') ?>" title="<?php esc_html_e('Min. price.', 'content-egg') ?>" />
<input type="text" class="form-control form-control-sm" ng-model="query_params.Amazon.maximum_price" ng-init="query_params.Amazon.maximum_price = ''" placeholder="<?php esc_html_e('Max. price', 'content-egg') ?>" title="<?php esc_html_e('Max. price.', 'content-egg') ?>" />
