...
<?php if (count($locales) > 1) : ?>
      <select class="form-control form-control-sm" ng-model="query_params.AmazonNoApi.locale" ng-init="query_params.AmazonNoApi.locale = '<?php echo esc_attr($default_locale); ?>'">
