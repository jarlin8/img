...
<div class="wrap gspb_welcome_div_container">
    ...
    <div class="gs-padd">
        ...
        <p class="gs-introtext"><?php esc_html_e("Thank you for using Greenshift. For any bug report, please, contact us ", 'greenshift-animation-and-page-builder-blocks'); ?> <a href="https://shop.greenshiftwp.com/contact-us/" target="_blank"><?php esc_html_e("through the contact form", 'greenshift-animation-and-page-builder-blocks'); ?></a></p>
    </div>
</div>