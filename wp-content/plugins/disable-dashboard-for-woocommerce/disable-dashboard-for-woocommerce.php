...
function wcbloat_all_settings( $settings, $current_section ) {
	...
	if ( $current_section == 'wcbloat' ) {
		...
		$settings_wcbloat[] = array(
			...
			'desc_tip' => __( 'Enabling this option will remove WooCommerce Dashboard Setup Widget from <a href="/wp-admin/index.php">WordPress Dashboard</a>.', 'disable-dashboard-for-woocommerce' ),
