...
//        }
    ...
    private function setup_cache_hooks() {
        ...
        if($integrations->has('litespeed-cache')) {
            add_action( 'litespeed_purge_all', [$this, 'clear_css_cache']);
        }
    ...
    public function toolbar_sniper_scripts() {
        ...
        wp_register_script( 'spai-sniper', 'https://' . (SHORTPIXEL_AI_DEBUG ? 'dev.shortpixel.ai' : parse_url($this->settings->behaviour->api_url, PHP_URL_HOST)) . '/assets/js/snip-3.0.min.js', [], '3.0.2', true );
