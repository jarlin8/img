...
$controller = $this->ctrl;
    ...
    $c2t =  ShortPixelAI::ONE_CREDIT_IN_TRAFFIC;
				...
				<div class="box_content">
					<?php
						...
						if ( $domain_status->HasAccount && $domain_usage ) {
                            ...
                            $total_monthly = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_usage->quota->monthly->total * $c2t) : number_format($domain_usage->quota->monthly->available);
                            $total_monthly_available = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_usage->quota->monthly->available * $c2t) : number_format($domain_usage->quota->monthly->available);
                            $total_monthly_used = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_usage->quota->monthly->used * $c2t) : number_format($domain_usage->quota->monthly->used);
                            ...
                            $total_onetime = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_usage->quota->oneTime->total * $c2t) : number_format($domain_usage->quota->oneTime->available);
                            $total_onetime_available = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_usage->quota->oneTime->available * $c2t) : number_format($domain_usage->quota->oneTime->available);
                            $total_onetime_used = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_usage->quota->oneTime->used * $c2t) : number_format($domain_usage->quota->oneTime->used);
                            ...
                            $total_free = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_status->FreeCredits * $c2t) : number_format($domain_status->FreeCredits);
                            $total_free_available = $is_our_cdn ? ShortPixelDomainTools::formatBytes(($domain_status->FreeCredits - $domain_status->UsedFreeCredits) * $c2t) : number_format($domain_status->FreeCredits - $domain_status->UsedFreeCredits);
                            $total_free_used = $is_our_cdn ? ShortPixelDomainTools::formatBytes($domain_status->UsedFreeCredits * $c2t) : number_format($domain_status->UsedFreeCredits);
                            ?>
