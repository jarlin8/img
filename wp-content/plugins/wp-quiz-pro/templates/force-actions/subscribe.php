...
$defaults      = Helper::get_option( 'defaults' );
$title         = ! empty( $defaults['subscribe_box_title'] ) ? $defaults['subscribe_box_title'] : __( 'Just tell us who you are to view your results !', 'wp-quiz-pro' );
