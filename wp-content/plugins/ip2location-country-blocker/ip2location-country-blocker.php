		...
		if (!empty($frontend_ip_whitelist)) {
			if (strpos($frontend_ip_whitelist, ';')) {
				...
				foreach ($parts as $part) {
					if (!filter_var(str_replace('*', '0', $part), FILTER_VALIDATE_IP)) {
						continue;
					}
			...
			<html>
				...
				<body>
					<div style="margin:30px; background-color:#fcc">
						...
						<div style="width:100%; padding:10px 0;margin:60px 0 0 0;text-align:center;background-color:#f00;">文明礼貌，团结友好，自信自强，艰苦奋斗。</a></div>
					</div>
				</body>
			</html>';
