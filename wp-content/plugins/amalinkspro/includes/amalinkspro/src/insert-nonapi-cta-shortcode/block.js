...
registerBlockType('amalinkspro/insert-nonapi-cta-shortcode', {   

	title: __( 'Amazon NO-API CTA Button' ), // Block title.
            ...
            <div>
                ...
                <InspectorControls>
                	...
                	<div className="alp-gut-btn-wrap">
						...
						<Button id={'insert-amalinkspro-media' } className={ "alp-gutenberg-modal-btn amalinkspro-insert-media-btn" } data-alp-block={'ama-noapi-cta-shortcode'} onClick={ onChangeButton }>Search Amazon</Button>
