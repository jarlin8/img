...
registerBlockType('amalinkspro/insert-table-shortcode', {   

	title: __( 'Product Comparison Table' ), // Block title.
            ...
            <div>
                ...
                <InspectorControls>
                	...
                	<div className="alp-gut-btn-wrap">
						...
						<Button id={'insert-amalinkspro-media' } className={ "alp-gutenberg-modal-btn amalinkspro-insert-media-btn" } data-alp-block={'alp-table-shortcode'} onClick={ onChangeButton }>Open Table Builder</Button>
