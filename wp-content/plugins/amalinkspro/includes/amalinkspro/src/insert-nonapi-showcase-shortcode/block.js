...
registerBlockType('amalinkspro/insert-nonapi-showcase-shortcode', {   

	title: __( 'Amazon NO-API Product Showcase' ), // Block title.
    ...
    keywords: [
        __( 'Amazon NO-API Product Showcase' ),
        __( 'amazon' ),
        __( 'Amazon' ),
    ],
            ...
            <div>
                ...
                <InspectorControls>
                	...
                	<div className="alp-gut-btn-wrap">
						...
						<Button id={'insert-amalinkspro-media' } className={ "alp-gutenberg-modal-btn amalinkspro-insert-media-btn" } data-alp-block={'ama-noapi-showcase-shortcode'} onClick={ onChangeButton }>Search Amazon</Button>
