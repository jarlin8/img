                                                        ...
                                                        <li class="wpbe_options_li <?php if (isset($f['move'])): ?>unsortable<?php endif; ?>" <?php if ($counter > 0): ?>style="display: none;"<?php endif; ?>>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <?php if (!in_array($key, array('__checker', 'ID')) AND $current_user_role == 'administrator'): ?>
                                                                    <input type="checkbox" value="1" disabled="" <?php checked($f['site_editor_visibility']) ?> class="site_editor_visibility" data-key="<?php echo esc_html__($key) ?>" id="site_editor_visibility_<?php echo $key ?>" />&nbsp;<label for="site_editor_visibility_<?php echo $key ?>"><?php esc_html_e('visible for the site editor', 'bulk-editor') ?>
