...
<ol>
    ...
    <li><?php
        printf(esc_html__('If your site is on the Russian language you should install %s for the correct working of WPBE with Cyrillic', 'bulk-editor'), WPBE_HELPER::draw_link(array(
...
<ul>
    <li class="wpbe-li-adv-container">
        <?php
        printf(esc_html__('If you like WPBE %s about what you liked and what you want to see in future versions of the plugin', 'bulk-editor'), WPBE_HELPER::draw_link([
...
<ul>
    <li><?php esc_html_e('Recommended min RAM', 'bulk-editor') ?>: 512 MB</li>
    <li><?php esc_html_e('Minimal PHP version is', 'bulk-editor') ?>: PHP 5.6</li>
...
<div class="col-lg-12">    
    <a href="https://wp-currency.com/" title="WPCS - WordPress Currency Switcher" target="_blank">
