<?php
/*
  Plugin Name: WPBE - WordPress Posts Bulk Editor and Posts Manager Professional
...
//***
        ...
        if (WPBE_HELPER::can_manage_data()) {
            add_action('admin_menu', function () {
                add_menu_page(esc_html__('WPBE Bulk Editor', 'bulk-editor'), esc_html__('WPBE Bulk Editor', 'bulk-editor'), 'publish_posts', 'wpbe', function () {
        ...
        add_action('admin_bar_menu', function ($wp_admin_bar) {
            ...
            if (isset($opt['options']['show_admin_bar_menu_btn']) AND intval($opt['options']['show_admin_bar_menu_btn']) === 1) {
                $args = array(
                    'id' => 'wpbe-btn',
                    'title' => esc_html__('WPBE Bulk Editor', 'bulk-editor'),
        ...
        add_action('admin_notices', function () use ($slug) {
            ...
            <div class="notice notice-info" id="pn_<?php echo $slug ?>_ask_favour" style="position: relative;">
                ...
                <div id="pn_<?php echo $slug ?>_review_suggestion">
                    <p><?php _e('Hi! Are you enjoying using <i>WPBE – WordPress Posts Bulk Editor Professional</i>?', 'bulk-editor'); ?></p>
                ...
                <div id="pn_<?php echo $slug ?>_review_no" style="display: none;">
                    <p><?php _e('We are sorry to hear you aren\'t enjoying WPBE. We would love a chance to improve it. Could you take a minute and let us know what we can do better?', 'bulk-editor'); ?></p>
                    <p>
