...
class Wpil_Settings
{
    ...
    public static function save()
    {
        if (isset($_POST['wpil_save_settings_nonce'])
            ...
            delete_transient('wpil_dofollow_domains');
    ...
    public static function getPossibleIgnoreLinkingTags(){
        return array('p', 'span', 'li', 'div', 'ul', 'ol', 'blockquote', 'td', 'th', 'strong', 'i');
    }
     ...
     * @return array
     **/
    public static function get_active_link_attrs($url = false, $remove_execeptions = false){
        $attrs = array();
    ...
    public static function ajax_save_domain_attributes(){
        ...
        $domain_rules = self::get_active_link_attrs($domain);
        ...
        $current_attrs = self::get_active_link_attrs($domain, true);
