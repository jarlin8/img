...
<div class="post_rewrite">
	...
	//license active option
	$license_active = get_option( 'wp_auto_spinner_license_active', '');
	...
	<?php }else{ 
		...
		//settings page URL wp_auto_spinner_settings
		$settings_page = admin_url('admin.php?page=wp_auto_spinner_settings');
		
		?>

		<p>Please visit the plugin <a href="<?php echo $settings_page ?>">settings page</a> and add your license key to activate the plugin!</p>
