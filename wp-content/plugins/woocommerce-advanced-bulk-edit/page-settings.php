		...
		<table class="form-table">
			<tr>
				...
				<td>
					...
					<p class="description"><?php _e( "The license key will allow you to use plugin auto-updates. If you don't have one, please purchase it ", "woocommerce-advbulkedit" ); ?>
						<a href="https://codecanyon.net/item/woocommerce-advanced-bulk-edit/8011417" target="_blank"><?php _e( "here", "woocommerce-advbulkedit" ); ?></a>.
					</p>
					<p>&nbsp;</p>
