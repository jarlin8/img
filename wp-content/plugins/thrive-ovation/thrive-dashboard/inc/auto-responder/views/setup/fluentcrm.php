...
<?php if ( ! empty( $installed ) ) : ?>
	<div class="tvd-row">
		<p><?php echo __( 'Click the button below to enable FluentCRM integration.', TVE_DASH_TRANSLATE_DOMAIN ) ?></p>
...
<?php else : ?>
	<p><?php echo __( 'You currently do not have FluentCRM plugin installed or activated.', TVE_DASH_TRANSLATE_DOMAIN ) ?></p>
	<br>
	<div class="tvd-card-action">
		<div class="tvd-row tvd-no-margin">
