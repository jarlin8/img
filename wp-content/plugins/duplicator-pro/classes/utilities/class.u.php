...
class DUP_PRO_U
{
    ...
    public static function initStorageDirectory()
    {
        ...
        SnapIO::chmod($home_path, 0755);

        //snapshot directory
        wp_mkdir_p($path_ssdir);
        SnapIO::chmod($path_ssdir, 0755);

        //snapshot tmp directory
        wp_mkdir_p($path_ssdir_tmp);
        SnapIO::chmod($path_ssdir_tmp, 0755);

        wp_mkdir_p($path_ssdir_tmp_import);
        SnapIO::chmod($path_ssdir_tmp_import, 0755);

        wp_mkdir_p($path_import);
        SnapIO::chmod($path_import, 0755);

        //plugins dir/files
        SnapIO::chmod($path_plugin . 'files', 0755);
