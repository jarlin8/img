...
final class Autoloader
{
    ...
    public static function load($className)
    {
        if (strpos($className, self::ROOT_NAMESPACE) !== 0) {
            foreach (self::getNamespacesExtraMapping() as $namespace => $mappedPath) {
    ...
    /**
     * Return external libs mapping
     *
     * @return string[]
     */
    protected static function getNamespacesExtraMapping()
    {
        return [
            'Amk\\JsonSerialize' =>  DUPX_INIT . '/vendor/andreamk/jsonserialize/src/'
        ];
    }
