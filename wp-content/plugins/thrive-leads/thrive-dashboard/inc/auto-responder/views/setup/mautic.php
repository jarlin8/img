...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-ac-api-key"><?php echo esc_html__( 'Public key', 'thrive-dash' ) ?></label>
		</div>
		<div class="tvd-input-field">
		...
		<div class="tvd-input-field">
			...
			<label
				for="tvd-aw-api-country"><?php echo esc_html__( 'Authentication Type', 'thrive-dash' ) ?></label>
		</div>
		<p><?php echo esc_html__( 'When using OAuth2 as the Authentication Type you need to reauthorize the connection after a certain amount of time (14 days by default) for more information please read the following', 'thrive-dash' ) ?><a href="https://thrivethemes.com/tkb_item/how-to-correctly-use-the-oauth2-authentication-type-in-our-mautic-integration" target="_blank"><strong><?php echo esc_html__( 'Knowledge Base Article', 'thrive-dash' ) ?></strong></a></p>
