...
class Script_Loader implements Model_Interface {
    ...
    */
    ...
    public function load_backend_scripts( $handle ) {
        ...
        if (
            ( $screen->base === 'thirstylink_page_thirsty-settings' && isset( $_GET[ 'tab' ] ) && in_array( $_GET[ 'tab' ] , array( 'tap_slmw_settings_section' , 'ta_help_settings' ) ) )
            ||
            ...
            if ( $screen->base === 'toplevel_page_tap-ms-license-settings-network' || $_GET[ 'tab' ] === 'tap_slmw_settings_section' ) {
