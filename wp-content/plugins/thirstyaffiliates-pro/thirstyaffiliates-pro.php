...
class ThirstyAffiliates_Pro extends Abstract_Main_Plugin_Class {
    ...
    */
        ...
        if ( is_multisite() ) {
            ...
            if ( $network_wide ) {
                ...
                foreach ( $blog_ids as $blog_id ) {
                    ...
                    delete_site_option( 'tap_option_update_data' );
            ...
            delete_option( 'tap_option_update_data' );
    ...
    private function _initialize_plugin_components() {
        ...
        $initiables     = array( $plugin_visibility , $autolinker , $geolocation , $amazon , $amazon_settings , $adv_reporting , $htaccess , $event_notification , $license , $guided_tour , $url_shortener , $input_link_picker , $settings , $health_checker , $preset_click_data );
